...
dependencies {
    ...
    intellijPlatform {
        ...
        // This plugin's annotator runs on top of the bundled YAML plugin's
        // PSI (org.jetbrains.yaml.psi.*) -- .gitlab-ci.yml is YAML, this
        // plugin only adds GitLab-CI-specific structural checks on top,
        // never a new parser.
